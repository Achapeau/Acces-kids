...
function messageIA({ chiffre , setChiffre, alphabet, setAlphabet, educatif, setEducatif }) {
  ...
  return (
    <div className='h-[70vh] w-[50vw] bg-yellow rounded-xl mx-auto text-greenDark items-center justify-center mx-20 absolute -top-[10vh] right-[4vw]'>
        ...
        <div className='flex items-center justify-center h-[23vh] w-[50vw] text-3xl absolute'>
            ...
            <img src={`${url}${urlImageOne}`} alt={`${value1}`} className='absolute left-[5vh] top-[5vw] h-[12vh] w-[12vh]' />
        ...
        <div className='flex items-center justify-center h-[23vh] w-[50vw] text-3xl'>
            ...
            <img src={`${url}${urlImageOne}`} alt={`${value1}`} className='absolute left-[5vw] top-[28vh] h-[12vh] w-[12vh]' />
            <img src={`${url}${urlImageTwo}`} alt={`${value2}`} className='absolute left-[15vw] top-[28vh] h-[12vh] w-[12vh]' />
        ...
        <div className='flex items-center justify-center h-[23vh] w-[50vw] text-3xl'>
            ...
            <img src={`${url}${urlImageTwo}`} alt={`${value2}`} className='absolute left-[5vw] top-[28vh] h-[12vh] w-[12vh]' />
            <div className='absolute right-[5vw] top-[32vh]'>
                <ButtonSpeakerGreen text={`${value2}`}  /> 
            </div>
        </div>}
        ...
        <div className='flex items-center justify-center h-[23vh] w-[50vw] text-3xl'>
            ...
            <img src={`${url}${urlImageOne}`} alt={`${value1}`} className='absolute left-[5vw] bottom-[5vh] h-[12vh] w-[12vh]' />
            <img src={`${url}${urlImageTwo}`} alt={`${value2}`} className='absolute left-[15vw] bottom-[5vh] h-[12vh] w-[12vh]' />
            <img src={`${url}${urlImageThree}`} alt={`${value3}`} className='absolute left-[25vw] bottom-[5vh] h-[12vh] w-[12vh]' />
        ...
        <div className='flex items-center justify-center h-[23vh] w-[50vw] text-3xl'>
            ...
            <img src={`${url}${urlImageThree}`} alt={`${value3}`} className='absolute left-[5vw] bottom-[5vh] h-[12vh] w-[12vh]' />
            <div className='absolute right-[5vw] bottom-[8vh]'>
                <ButtonSpeakerGreen text={`${value3}`}  /> 
            </div>
        </div>}
